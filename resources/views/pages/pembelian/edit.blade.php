<div class="modal fade" id="largeModal-{{ $row->id_supplier }}" tabindex="-1" role="dialog"
    aria-labelledby="largeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('supplier.update', ['supplier' => $supplier->id_supplier]) }}" method="post"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="mediumModalLabel">Edit supplier <i>{{ $supplier->nama }}</i></h5>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nama" class="control-label mb-1">Nama</label>
                        <input id="nama" name="nama" type="text" class="form-control" value="{{ $supplier->nama }}"
                            required>
