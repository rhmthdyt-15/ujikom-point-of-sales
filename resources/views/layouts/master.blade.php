...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('templates/images/icon4.png') }}">
    <link rel="shortcut icon" href="{{ asset('templates/images/icon4.png') }}">
...
<body>
    ...
    <script src="{{ asset('templates/assets/js/init/weather-init.js') }}"></script>
    ...
    <!-- local -->
    <script src="{{ asset('templates/assets/js/widgets.js') }}"></script>
    @stack('scripts')
</body>
</html>
